// using JobBoardAPI -- to be continued;
...
namespace JobBoardAPI
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Job Board", Version = "v1.0.0", Description = "Job Board Auth API" });
            ...
            using (var scope = app.Services.CreateScope())
            {
                ...
                // Use emailService within the scope.
            }
